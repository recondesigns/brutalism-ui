...
[Github](https://github.com/recondesigns/brutalism-ui/tree/main/src/components/Modal)
&nbsp;|&nbsp;
...
Import the component, and add custom content, or use the Modal's Building blocks.
...
<Modal>
  ...
  <Modal.Footer actions={footerActionsObj} />
</Modal>
```
